...
// Source: data/pages/cardiology-clinic-cleaning.json (extracted from the previous static cardiology-clinic-cleaning.html)
...
const SLUG = "cardiology-clinic-cleaning"
