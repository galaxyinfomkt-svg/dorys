// Route for the rehab clinic + senior care pillar page.
// Source: data/pages/senior-care-rehab-cleaning.json, built by
// scripts/build-senior-rehab-page.mjs (npm run build:service-pages).
