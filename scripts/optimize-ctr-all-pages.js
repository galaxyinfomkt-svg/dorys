...
const SERVICE_CTR_CONFIG = {
 ...
 triggers: ['Same Day Service', 'Licensed & Insured', '5★ Rated', 'Free Estimate', 'Trusted With Over 22 Years of Experience'],
 titlePatterns: [
...
function processLocationPage(filePath, city) {
 ...
 `Professional Cleaning ${city.name} | With Over 22 Years of Experience`
 ];
