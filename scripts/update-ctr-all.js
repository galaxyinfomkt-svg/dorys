...
const serviceConfig = {
 ...
 'general-housekeeping': { name: 'Housekeeping', hook: 'Trusted With Over 22 Years of Experience', seasonal: '50% Off!' },
...
function getLocationMeta(cityName, citySlug) {
 ...
 desc: `🏡 ${cityName}'s premium cleaners! Trusted by luxury homeowners. With Over 22 Years of Experience, white-glove service. ✅ Same-day. LIMITED slots! (978) 307-8107`
 },
 historic: {
 title: `${cityName} House Cleaning | ⭐ Historic Home Experts - 50% Off!`,
 desc: `🏛️ ${cityName}'s trusted cleaners! Experts in historic New England homes. With Over 22 Years of Experience, $2M insured. ✅ Same-day. 50% off 1st! (978) 307-8107`
 },
 commercial: {
 title: `${cityName} Office & Home Cleaning | ⭐ With Over 22 Years of Experience - 50% Off!`,
 desc: `🏢 ${cityName}'s commercial & residential experts! Office, home, carpet cleaning. With Over 22 Years of Experience. ✅ FREE estimate. 50% off 1st! (978) 307-8107`
 },
 standard: {
 title: `${cityName} Cleaning Services | ⭐ Local With Over 22 Years of Experience - 50% Off!`,
...
function getServiceLocationMeta(cityName, citySlug, serviceSlug) {
 ...
 desc = `❄️ ${cityName}'s #1 carpet cleaners! Remove winter salt & stains. With Over 22 Years of Experience, eco-safe. ✅ Same-day available. LIMITED: 50% off! (978) 307-8107`;
 } else if (type === 'luxury') {
 ...
 desc = `🏢 ${cityName} commercial cleaning experts! Offices, warehouses, medical. With Over 22 Years of Experience. ✅ FREE walkthrough. LIMITED slots! (978) 307-8107`;
 } else {
 title = `${cityName} ${config.name} | ⭐ ${config.hook} - ${config.seasonal}`;
