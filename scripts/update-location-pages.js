...
const regexReplacements = [
 ...
 [/Choose from our comprehensive range of professional cleaning services available in ([^,]+), Massachusetts\./g, 'Choose from our healthcare services available in $1, Massachusetts.'],
 // CTA H2
