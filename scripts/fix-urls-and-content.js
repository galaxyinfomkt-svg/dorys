    ...
    <section class="section section--gradient">
      <div class="container">
        <div class="section__header section__header--center">
          ...
          <h2 class="section__title">Our Difference</h2>
        </div>
        <div class="trust-grid">
          <div class="trust-card animate-on-scroll animate-fade-up">
            ...
            <p class="trust-card__text">Serving Massachusetts families and businesses for over 22 years with professional, reliable cleaning services.</p>
          </div>
